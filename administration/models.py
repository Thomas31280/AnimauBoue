...
class Clients(models.Model):
    ...
    email = models.EmailField(unique=True, max_length=65, blank=True)
...
class Reservations(models.Model):
    ...
    dog_2_arrival = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_2_departure = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_3 = models.ForeignKey(Dogs, on_delete=models.CASCADE, blank=True, null=True, related_name='dog_3_relation')
    dog_3_arrival = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_3_departure = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_4 = models.ForeignKey(Dogs, on_delete=models.CASCADE, blank=True, null=True, related_name='dog_4_relation')
    dog_4_arrival = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_4_departure = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_5 = models.ForeignKey(Dogs, on_delete=models.CASCADE, blank=True, null=True, related_name='dog_5_relation')
    dog_5_arrival = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
    dog_5_departure = models.DateTimeField(auto_now=False, auto_now_add=False, blank=True)
