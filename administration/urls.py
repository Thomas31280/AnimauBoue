...
from . import views
from administration.views import ConnectAdminSpace, UpdateProfile, ParksAvailability, AddClient, ReservationForm, AddReservation, ArrivalAndDeparture, UpdateClient, NewDog, UpdateReservation, UpdateDog, Stats
...
urlpatterns = [
    ...
    url(r'^add_client_form', AddClient.as_view(), name="add_client_form"),
    ...
    url(r'^add_dog/$', NewDog.as_view(), name="add_dog"),
